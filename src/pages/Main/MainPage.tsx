    ...
    <Layout>
      <div className={styles.background_main}>
        ...
        <section className={styles.main}>
          <div className={styles.main_title_container}></div>
      ...
      <section className={styles.heading_form}>
        ...
        <CustomButton
          ...
          label={
            width > 520
              ? "Рассказать нам о своем проекте"
      ...
      <section className={styles.price} id="price">
        ...
        <div className={styles.price_container}>
          <TariffCard
            ...
            iconName="start"
            features={[
              { text: "Дизайн лендинга (1 страница)", included: true },
              { text: "Подключение формы заявки", included: true },
              {
                text: "Базовая адаптация под мобильные устройства",
                included: true,
              },
              { text: "Подключение домена и хостинга", included: true },
              {
                text: "Первичная SEO-настройка (метатеги, фавикон)",
                included: true,
              },
              {
                text: "Срок — 7 дней",
              ...
              { text: "Другие разделы сайта", included: false },
              { text: "Персональный менеджер", included: false },
              { text: "Дополнительные языковые версии", included: false },
            ]}
          />
          <TariffCard
            title="Стандарт"
            subtitle="Оптимально для малого и среднего бизнеса"
            iconName="standart"
            features={[
              { text: "Многостраничный сайт (до 7 экранов)", included: true },
              {
                text: "Дизайн и прототипирование всех ключевых разделов",
                included: true,
              },
              { text: "Адаптив под мобильные устройства", included: true },
              {
                text: "Подключение форм заявок и обратной связи",
                included: true,
              },
              {
                text: "Интеграция с CMS (WordPress или Tilda)",
                included: true,
              },
              { text: "Базовое наполнение контентом", included: true },
              {
                text: "Первичная SEO-настройка (метатеги, фавикон, карта сайта)",
                included: true,
              },
              { text: "14 дней технической поддержки", included: true },
              { text: "Персональная фото/видеосъемка", included: false },
              { text: "Мультиязычная версия", included: false },
            ]}
          />
          <TariffCard
            title="Премиум"
            ...
            features={[
              {
                text: "Индивидуальный дизайн всех страниц (до 20 экранов)",
                included: true,
              },
              {
                text: "Глубокое прототипирование пользовательских сценариев",
                included: true,
              },
              { text: "Персональный менеджер проекта", included: true },
              {
                text: "Эксклюзивная анимация и интерактивные элементы",
                included: true,
              },
              {
                text: "Полная адаптивность под все устройства",
                included: true,
              },
              { text: "Мультиязычная версия (RU/EN)", included: true },
              { text: "Интеграция с CRM и расширенные формы", included: true },
              {
                text: "Заполнение уникальным контентом (текст/графика)",
                included: true,
              },
              { text: "Расширенная SEO-оптимизация", included: true },
              { text: "30 дней технической поддержки", included: true },
            ]}
          />
        </div>
      </section>
